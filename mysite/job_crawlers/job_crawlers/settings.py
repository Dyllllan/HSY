# Scrapy settings for job_crawlers project
#
...
# Obey robots.txt rules (设置为False以允许爬取，但请遵守网站使用条款)
ROBOTSTXT_OBEY = False

# Concurrency and throttling settings
CONCURRENT_REQUESTS = 8
CONCURRENT_REQUESTS_PER_DOMAIN = 2
DOWNLOAD_DELAY = 2  # 增加延迟以避免被封IP
RANDOMIZE_DOWNLOAD_DELAY = 0.5  # 随机延迟0.5倍

# Enable cookies (智联招聘可能需要cookies)
...
DEFAULT_REQUEST_HEADERS = {
    ...
    "Accept-Encoding": "gzip, deflate, br",  # 现在支持Brotli压缩了
